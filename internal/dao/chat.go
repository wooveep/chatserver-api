 ...
 * @LastEditTime: 2023-06-25 15:43:03
...
type ChatDao interface {
	...
	ChatRecordIdGet(ctx context.Context, chatId int64) ([]int64, error)
	...
	ChatFuncHisGet(ctx context.Context, chatId, start, end int64) ([]model.RecordOne, error)
